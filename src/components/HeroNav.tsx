      ...
      <header className="absolute inset-x-0 top-0 z-50">
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          ...
          <div className="hidden lg:flex lg:gap-x-12">
            {navigation.map((item) => (
              <p key={item.name} onClick={() => handleClickScroll(item.href)} className="text-sm font-semibold leading-6 text-white cursor-pointer">
                {item.name}
              </p>
            ))}
          </div>
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              ...
              <p onClick={() => handleClickScroll("who-we-are")} className="text-sm font-semibold leading-6 text-white cursor-pointer">
