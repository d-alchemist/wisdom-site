		...
		<div className='pb-10' id='career'>
			<div className='relative isolate z-10 mt-16 sm:mt-20' id='career'>
				<div className='mx-auto max-w-7xl sm:px-6 lg:px-2'>
					<div className='mx-auto flex max-w-2xl flex-col gap-16 shadow-lg bg-gray-50 bg-white/5 px-6 py-16 ring-1 ring-white/10 sm:rounded-3xl sm:p-8 lg:mx-0 lg:max-w-none lg:flex-row lg:items-center lg:py-10 xl:gap-x-20 xl:px-10'>
						<img
							className='h-[500px] w-full flex-none rounded-2xl object-cover shadow-xl lg:aspect-square lg:h-auto lg:max-w-lg'
